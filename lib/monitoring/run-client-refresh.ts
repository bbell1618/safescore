...
export async function runClientRefresh(
  ...
  if (saferSnapshot) {
    const censusPayload = {
      ...
      physical_address: saferSnapshot.physicalAddress,
      mailing_address: saferSnapshot.mailingAddress,
      operation_classification: saferSnapshot.operationClassification,
