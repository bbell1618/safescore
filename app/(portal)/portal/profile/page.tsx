...
function ProfileRow({
  ...
  return (
    <div className="flex items-start justify-between gap-4 py-3 border-b border-[#F0E8DA] last:border-0">
      ...
      <span className="text-sm text-[#1E1C1A] text-right">{value ?? "—"}</span>
    </div>
  );
}
...
export default async function PortalProfilePage() {
  ...
  if (!userRecord?.client_id) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center gap-4">
        ...
        <div>
          <h2 className="text-lg font-bold text-[#1E1C1A]">Your account is being set up</h2>
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      {/* Page header */}
      <div>
        <h1 className="text-xl font-bold text-[#1E1C1A]">Settings</h1>
      ...
      <div className="bg-[#FBF7F0] rounded-xl border border-[#F0E8DA] p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-semibold text-[#1E1C1A] text-sm">Company information</h2>
        </div>
      ...
      <div className="bg-[#FBF7F0] rounded-xl border border-[#F0E8DA] p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-semibold text-[#1E1C1A] text-sm">Fleet</h2>
        </div>
      ...
      <div className="bg-[#FBF7F0] rounded-xl border border-[#F0E8DA] p-5">
        ...
        {(subscription as any)?.status && (
          <div className="flex items-start justify-between gap-4 py-3 border-b border-[#F0E8DA]">
            ...
            <span className="text-sm text-[#1E1C1A] capitalize">
      ...
      <div className="bg-[#FBF7F0] rounded-xl border border-[#F0E8DA] p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-semibold text-[#1E1C1A] text-sm">Notification preferences</h2>
        </div>
      ...
      <div className="bg-[#FBF7F0] rounded-xl border border-[#F0E8DA] p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-semibold text-[#1E1C1A] text-sm">Service agreement</h2>
        </div>

        {serviceAgreement ? (
          <div className="flex items-center justify-between gap-4 py-2">
            <div>
              <p className="text-sm font-medium text-[#1E1C1A]">{serviceAgreement.filename}</p>
      ...
      <div className="bg-[#FBF7F0] rounded-xl border border-[#F0E8DA] px-5 py-4 flex items-center gap-3">
        <div className="w-7 h-7 rounded-full bg-[#C67A1E]/10 flex items-center justify-center shrink-0">
          <Info className="w-3.5 h-3.5 text-[#C67A1E]" />
        </div>
        <p className="text-sm text-gray-500">
...
function ManageBillingButton() {
  return (
    <form action="/api/billing/portal" method="POST">
      <button
        type="submit"
        className="px-4 py-2 bg-[#1B2D4F] text-white text-sm font-medium rounded-lg hover:bg-[#2a2a2a] transition-colors"
      >
        Manage billing
      </button>
    </form>
