...
export function WorkItemRow({ title, href, priority = 3, timing, detail, action, children, id }: { title: string; href?: string; priority?: 0 | 1 | 2 | 3; timing: string; detail?: string; action?: ReactNode; children?: ReactNode; id?: string }) {
